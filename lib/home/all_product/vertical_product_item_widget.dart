                        ...
                        widget.product.discount! > 0? Container(
                            ...
                            child: textView12(
                                ...
                                text: PriceConverter.percentageCalculation(context, widget.product.unitPrice!,
                                    widget.product.discount!, widget.product.discountType!))) : const SizedBox(),

                ),
                 Align(
                    alignment: Alignment.bottomLeft,
                    child:
                    //TODO:API create field for verify instate refundable attr
                    ...
                    //   onTap: ()=>{ },
                    //   icon: Icon(Icons.verified_user_outlined,size: 14,color: Colors.white,),
                    ...
                    //   width: 120,
                    //   height: 20,text:
                    // textView11(context: context, text: 'verify_shop'.tr ,color: Colors.white,height: 1),
                    // ) : const SizedBox.shrink(),
