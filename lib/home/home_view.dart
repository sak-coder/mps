...
class _HomeViewState extends State<HomeView> with TickerProviderStateMixin {
  ...
  void getData() async {
    Get.find<BannerViewController>().getMainBanner();
    Get.find<BannerViewController>().getFooterBanner();
    ...
    Get.find<HomeController>().getFlashDeal();
    ...
    //
    // var platform = const MethodChannel('mps');
    // try {
    //   await platform.invokeMethod('testing',
    //       {'title': "MyPhsar" });
            ...
            title: Row(
              ...
              children: [
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        bottom: 10, top: 10, right: 10, left: 0),
                    child: InkWell(
                      onTap: () async {
                ...
                Obx(() => badgeIcon(
                    ...
                    endP: -2,
                    visibleBadge:
                        Get.find<HomeController>().cartCount > 0 ? true : false,
                    context: context,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: InkWell(
                                          onTap: () {
                                            Get
                                                .to(() => const InstallmentProductView());
                                          },
                                          child: Container(
                                            decoration: customDecoration(
                                                shadowBlur: 1,
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() =>
                  Get
                      .find<DailyDealController>()
                      .getDailyDealProductListModel
                      .length > 0
                    ...
                    children: [
                      ...
                      Get.find<HomeController>().obx(
                          (state) => ProductItemGridView(
                              ...
                              Get.find<HomeController>().getRandomProductList,
                              scrollController,
                              callRequest),
                          onLoading: productShimmerView(context),
                          onError: (s) => onErrorReloadButton(
                                  context, s.toString(), height: 300,
                                  onTap: () {
                                Get.find<HomeController>()
                                    .getRandomLatestProduct(1);
                              }),
                          onEmpty: SizedBox(
                              height: 298,
