...
class _DashBoardViewState extends State<DashBoardView> {
  ...
  Future<void> getData() async {
    ...
    Get.find<DashBoardController>().loadDataStatus.value = true;
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() => Get.find<DashBoardController>().loadDataStatus.value == false
        ?    Scaffold(appBar: customAppBarIconView(context: context, titleText: "", icon: Container(margin:EdgeInsets.only(left: 10),child: Icon(Icons.close))),
    body:  loaderFullScreenView(context, true,bgColor: Colors.white) ,)
            : PersistentTabView(
      tabs: _tabs(),
  ...
  List<PersistentTabConfig> _tabs() => [
        PersistentTabConfig(
          screen: Focus(
              skipTraversal:true, child:  HomeView(
